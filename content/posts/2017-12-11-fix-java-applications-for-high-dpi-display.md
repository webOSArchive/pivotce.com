...
summary: Does webOS Quick Install look like this on your computer? Well, if you have a high resolution display (QHD+, 4k, etc.) on your Windows PC, there’s a fix for that.
...
Does [webOS Quick Install](/2013/12/25/happy-christmas/) look like this on your computer? Well, if you have a high resolution display (QHD+, 4k, etc.) on your Windows PC, there’s a fix for that.
