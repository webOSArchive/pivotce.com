---
title: Deal – 2 Coupons from PIC and OpenMobile
date: '2013-11-01T19:44:32Z'
lastmod: '2013-12-02T19:56:38Z'
author: Alan Morford
...
tags:
- Deal
slug: deal-2-coupons-from-pic-and-openmobile
summary: It looks like OpenMobile is offering a $5 off code on their Twitter and Phoenix International Communications is offering a $10 off code on their store for entering your email…
source_url: https://pivotce.com/2013/11/01/deal-2-coupons-from-pic-and-openmobile/
wordpress_id: 392
archived: true
comment_page: 2013-11-01-deal-2-coupons-from-pic-and-openmobile
---

It looks like [OpenMobile](www.openmobileww.com) is offering a $5 off code on their Twitter and [Phoenix International Communications](http://phxdevices.com) is offering a $10 off code on their [store](http://store.phxdevices.com/index.php?id_product=8&controller=product) for entering your email address. Unfortunately, you can’t combine them but if you buy two licenses seperately (add one to cart, checkout, repeat) you can save $15!

> [#ACLforwebos](https://twitter.com/search?q=%23ACLforwebos&src=hash) will be here before you know it! Pre-order & use code ACL5T for $5 off! Apps on [#webOS](https://twitter.com/search?q=%23webOS&src=hash)… here we come! <http://t.co/qA114I7IGA>
>
> — OpenMobile (@openmobileww) [November 1, 2013](https://twitter.com/openmobileww/statuses/396257963801071616)
...
To all those pre-orderers of ACL for webOS, OpenMobile sent emails awarding a $10 off code for their OpenMobile AppMall.  There is some [speculation](http://forums.webosnation.com/hp-touchpad/324645-pic-kick-starts-touchpad-open-mobile-acl-71.html#post3405995) to the legality of the AppMall but as of yet, there seems to be no hard evidence to support the validity of these claims.  OpenMobile [claims](http://www.prnewswire.com/news-releases/openmobile-world-wide-launches-appmall-185871182.html) they have “partnered with highly reputable content companies and distributors in the world to deliver premium content as well as the best free applications”.  See their message to me below:
...
|  |  |
| --- | --- |
| ***![Photo Credit: OpenMobile](/images/files/2013/11/appmall_icon_webos_082613.png)OpenMobile AppMall*** | *The AppMall is the world’s largest independent app superstore and it auto-installs upon ACL download! That means you have instant access to a broad app catalog from which you can start downloading some of your favorite Android apps! The AppMall is a native Android app that runs on your TouchPad with ACL. All apps that are included in the AppMall have been tested and validated to work on your ACL-enabled TouchPad. The catalog is growing daily! Any apps that you want but don’t see? Let us know! Just find the AppMall icon and click to start searching, browsing, downloading, and installing Android apps directly to your HP TouchPad!* |

***Any questions regarding the OpenMobile AppMall? Send the OpenMobile Help Desk an email at: [support@openmobileww.com](mailto:support@openmobileww.com?subject=Question%20from%20ACL%20for%20webOS%20Pre-Order%20Customer%20RE%3A%20AppMall)*** *Happy App-ing!
– The OpenMobile Team*
