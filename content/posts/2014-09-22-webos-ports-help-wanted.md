---
title: 'webOS Ports: Help Wanted'
date: '2014-09-22T04:37:15Z'
lastmod: '2014-11-11T13:39:25Z'
author: webosports
author_slug: webosports
categories:
- News
slug: webos-ports-help-wanted
summary: The webOS community may be a bit smaller these days but it’s no less devoted to the platform. And it’s that community that is rallying behind us here at webOS…
featured_image: /images/files/2014/09/helpwantedheader.jpg
source_url: https://pivotce.com/2014/09/22/webos-ports-help-wanted/
wordpress_id: 2123
...
Everyone can help in some way. We need testers and bug reports! Sign up on the [webOS-Ports Bug Tracker](http://issues.webos-ports.org/projects/ports/issues?set_filter=1), contact us to let us know that you signed up and what your username is, and we’ll upgrade your account so you can post issues.
...
IRC #webos-ports
Bug Tracker: [webOS-Ports Bug Tracker](http://issues.webos-ports.org/projects/ports/issues?set_filter=1)
[webOSnation Forums](http://forums.webosnation.com/members/572806.html) User Support Forums
[LuneOS Developer Mailing List](http://lists.webos-ports.org/mailman/listinfo/luneos-dev) Developer ONLY Mailing List, no User Support.

Join the forum [conversation](http://forums.webosnation.com/luneos/328615-pivotce-webos-ports-help-wanted.html).
