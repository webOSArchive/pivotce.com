...
date: '2015-08-17T11:39:48Z'
lastmod: '2015-09-08T03:09:31Z'
author: webosports
...
summary: Over summer things always slow down a bit which is why we didn’t have a release last month. It’s about quality and because we basically had too many loose ends that needed…
...
A new Google Maps app rewritten in Enyo 2 by [72ka](/2014/09/19/dev-highlight-72ka/) (the author of the legendary Google Maps app for legacy webOS (written in Mojo)) has been included in our images as well. It works fairly well already, considering this is an initial alpha release. It will need some polishing for sure but basic functionality is already there.
...
[C+Dav](/2014/11/11/use-caldav-to-maintain-google-calendar-sync/) has been updated to 0.3.33 which fixes various issues and improves stability.
