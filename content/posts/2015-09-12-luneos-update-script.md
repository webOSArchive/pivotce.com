---
title: LuneOS Update Script
date: '2015-09-12T14:49:08Z'
author: Chairman Honeycrisp
author_slug: chairmanhoneycrisp
categories:
- News
slug: luneos-update-script
summary: With all the progress that the LuneOS dev team has been making recently (For example, finally squashing a nasty browser bug, and allowing many legacy webOS apps to run), it’s…
featured_image: /images/files/2015/09/luneosupdate.jpeg
source_url: https://pivotce.com/2015/09/12/luneos-update-script/
wordpress_id: 3226
featured_image_source: https://pivotce.com/files/2015/09/luneosupdate.jpeg
archived: true
---

With all the progress that the LuneOS dev team has been making recently (For example, [finally squashing a nasty browser bug, and allowing many legacy webOS apps to run](/2015/09/07/luneos-september-stable-release-cafe-de-olla/)), it’s important to keep up with the latest and greatest LuneOS builds. When it comes to Nexus devices, installing LuneOS is a simple matter of flashing the latest zip file using ClockworkMod, it was more complicated on the HP Touchpad… until now! Read on past the jump, and we’ll show you how to get the latest stable or nightly build of LuneOS in a jiffy.
...
[LuneOS Official Release Post](/2014/09/01/official-release-of-luneos-and-project-updates/)

[LuneOS Latest Stable Release Post (Cafe de Olla, as of September 2015)](/2015/09/07/luneos-september-stable-release-cafe-de-olla/)

[A pivotCE Review of LuneOS Crema](/2015/08/06/luneos-cafe-cubano-an-in-depth-look/)

[pivotCE’s Preware Feeds are Ready for LuneOS!](/2015/08/09/ready-for-luneos/)
