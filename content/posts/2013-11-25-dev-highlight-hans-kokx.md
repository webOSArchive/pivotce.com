---
title: 'Dev Highlight: Hans Kokx'
date: '2013-11-25T02:22:22Z'
lastmod: '2013-12-02T20:08:02Z'
author: Alan Morford
...
tags:
- Developer
slug: dev-highlight-hans-kokx
summary: Welcome back pivotCE fans! We have another interview for you! Hans Kokx comes to us from the webOS Ports Team (among other areas of webOS-dom). See below for our conversation.
source_url: https://pivotce.com/2013/11/25/dev-highlight-hans-kokx/
wordpress_id: 594
archived: true
---
...
![avatar](/images/files/2013/11/avatar-300x300.jpg)
*HaDAk*
...
I’m the author of the webOS Ports installer script.  It’s still in its infancy, but it will evolve over time.  Keep an eye out on github for it to be released – <https://github.com/webOS-ports/webos-ports-sdk/tree/master/scripts>. ![Screen Shot 2013-11-18 at 8.43.16 PM](/images/files/2013/11/Screen-Shot-2013-11-18-at-8.43.16-PM.png)**Have you written any patches?**
...
I’ve also been working on a Quick Reply bar for the mail client – the aim is to add a single text area below the message text that you can use to quickly reply to the message you’re reading, without the need to launch a full card. *[author comment: you can see both patches in the photo below]*![Better Email Header](/images/files/2013/11/email_2013-18-11_205034.png)
...
![GCW Zero WiFi](/images/files/2013/11/Screen-Shot-2013-11-18-at-8.43.32-PM-300x223.png)I’m working on writing system apps for the [GCW-Zero](http://www.gcw-zero.com/) right now.  The GCW-Zero is a handheld game console running open-source software.  It lacked a decent wireless manager so I am giving it a shot.  You can find more information in the (unofficial) repository at this time: <http://www.superlongname.com/play/unofficial-wifi-application-created-by-hadak>
