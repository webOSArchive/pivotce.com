 ...
 *
 * The blog pages fetch this endpoint client-side and inline the result,
 * so the menu (including its hover dropdowns) lives in the page DOM.
 * Because it's served from the same origin as the blog, no CORS is needed.
 *
...
// blog host sits behind a TLS-terminating reverse proxy.
