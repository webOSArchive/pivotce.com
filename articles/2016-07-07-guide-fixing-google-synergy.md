...
date: 2016-07-07 07:42:53 UTC
modified: 2024-01-25 22:25:36 UTC
author: Alan Morford
...
excerpt: 'Here’s the scenario: you’ve dug out your Pre or TouchPad and for nostalgia sake try to set it up only to find that things are a bit tougher to get…'
---

# Guide: Fixing Google Synergy
...
[Bypass Activation [webOS 1.x]](http://www.webosnation.com/bypass-activation-webos-1-x) (this now works for all webOS versions if you use the [devicetool.jar from here](https://pivotce.com/2015/12/13/the-ultimate-bypass-activation-tool/)).
...
If you’re on a webOS 1.x device you’ll need the [devicetool.jar from here](https://pivotce.com/2015/12/13/the-ultimate-bypass-activation-tool/) to do it or if you already have Preware installed you can grab the [Unhide Dev Mode Icon](http://preware.pivotce.com/package/org.webosinternals.patches.app-launcher-unhide-dev-mode-icon) installer to check that it’s still enabled.
...
![preware_2014-20-10_213512](../images/files/2014/10/preware_2014-20-10_213512.png)[Follow Step 10](https://pivotce.com/2014/10/21/guide-coming-back-to-webos-in-2014-part-1/) from our guide to install Preware then come back!
...
Step 6 from our [Coming (Back) to webOS in 2014 guide](https://pivotce.com/2014/10/21/guide-coming-back-to-webos-in-2014-part-1/) is a good idea as well but not required. Might as well get all of those certificates updated though.
