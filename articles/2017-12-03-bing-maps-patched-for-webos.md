...
wordpress_id: 4203
excerpt: Bing Maps has been patched for their latest API change for webOS. webOS Nation forums user, Misj’, has developed two patches to cover both the Pre and TouchPad bases.
---

# Bing Maps Patched for webOS
