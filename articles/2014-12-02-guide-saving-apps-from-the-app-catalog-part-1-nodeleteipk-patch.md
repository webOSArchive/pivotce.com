...
date: 2014-12-02 19:15:01 UTC
modified: 2015-04-17 03:51:27 UTC
author: Brent Hunter
...
excerpt: '** PLEASE NOTE: Following the closure of the HP app catalogue, the instructions in this article are no longer relevant. It is now of historical interest only. ** The time…'
---
...
This guide assumes that you have followed the instructions in [the welcome back guide](http://pivotce.com/2014/10/21/guide-coming-back-to-webos-in-2014-part-1/), and that your device is ready for patching. Please note that we will be using webOS Quick Install for this process as Preware does not support installing patches that don’t come from an official feed.
